...
<mark>Data -> Manage variables in active data set -> Delete variables in active data set</mark>
...
<mark>Data -> Manage variables in active data set -> Recode variables</mark>

![](./pict/recodeNArcmdr.png)

- in the recode variables window select variables you wont to recede and in the code write **`NA=0`** 
...
<mark>Data -> Manage variables in active data set -> Convert numeric variables to factors</mark>
...
-   In R commander.
-   Activate **Leptospcasen** data set.
